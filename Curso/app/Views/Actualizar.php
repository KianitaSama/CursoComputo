...
<?php 
    ...
    $sementre = $datos[0]['sementre'];
    $externo = $datos[0]['externo'];
...
<ul class="uk-breadcrumb" style="padding:  0px 70px 0px 70px">
    <a class="btn-btn" href="<?php echo base_url();?>./registro">Regresar</a>
</ul>
    ...
    <div class="container">
		...
		<form method="POST" action="<?php echo site_url().'actualizar'?>">
			...
			<div class="form-row">
			  ...
			  <div class="form-row">
			    ...
			    <div class="form-group col-md-4">
			      ...
			      <select id="modalidad" class="form-control" name="modalidad" value="<?php echo $modalidad?>">
			        <option >Egresado </option>
			    ...
			    <div class="form-group col-md-4">
			      ...
			      <select id="sementre" class="form-control" name="sementre" value="<?php echo $sementre?>">
			        <option >Egresado </option>
			    ...
			    <div class="form-group col-md-4">
			      ...
			      <select id="externo" class="form-control" name="externo" value="<?php echo $externo?>">
			...
			<div class="form-group col-md-8">
			      ...
			      <select id="curso" class="form-control" name="curso" value="<?php echo $curso?>">
